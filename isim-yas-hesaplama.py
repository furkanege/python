...
if (yas >= 1 and yas < 12 and cinsiyet == "e"):
    print("Merhaba {}, yaşınız {}, daha çocuksun :)".format(isim, yas))
if (yas >= 1 and yas < 12 and cinsiyet == "k"):
    print("Merhaba {}, yaşınız {}, daha çocuksun :)".format(isim, yas))


elif (yas >= 12 and yas < 28 and cinsiyet == "e"):
    print("Merhaba {} bey, yaşınız {}, hala çok gençsiniz".format(isim, yas))
elif (yas >= 12 and yas < 28 and cinsiyet == "k"):
    print("Merhaba {} hanım, yaşınız {}, hala çok gençsiniz".format(isim, yas))


elif (yas >= 28 and yas < 40 and cinsiyet == "e"):
...
elif (yas >= 40 and yas < 60 and cinsiyet == "e"):
